      ...
      <div className="bg-navfooter">
        <div className="container lg:grid grid-cols-2 border-b border-textcolor ">
          <div className="w-80 m-auto  pt-11 pb-11">
            <h1 className="text-textcolor  font-poppins-bold text-2xl">
          ...
          <div className="m-auto  w-[400px] mb-[50px]">
            ...
            />
            <button className="p-2 w-14 rounded-md m-2 font-poppins-medium bg-primary text-textcolor">
              Run
            </button>
          </div>
        </div>
        <div className="container lg:grid grid-cols-2 ">
          <div className="m-auto  w-80 mt-[50px] mb-[50px]">
            <img alt="not" src={Logo} alt="" />
            <p className="ml-[110px]  text-textcolor ">
              Lorem ipsum dolor sit amet consectetur, adipisicing elit.
              Exercitationem, vel!
            </p>
            <div className="container    flex mt-4">
              <img alt="not" className="ml-28" src={twitter} alt="" />
              <img alt="not" className="ml-4" src={pinterest} alt="" />
              <img alt="not" className="ml-9" src={fb} alt="" />
              <img alt="not" className="ml-4 " src={insta} alt="" />
            </div>
          </div>
          <div className="m-auto  w-[400px] mt-[50px] pb-[50px]">
            <div className="container flex text-textcolor">
              ...
              <div className="">
                <h1 className="font-poppins-bold">Resources</h1>
                <p className="p-6 font-poppins-light pb-0 pl-0">
                  Terms of Services
                </p>
          ...
          <div className=" border-primary container font-poppins-light flex text-textcolor pb-[50px]">
            <img alt="not" className="ml-32 " width={20} src={footer} alt="" />
