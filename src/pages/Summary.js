          ...
          <div className="bg-gray">
            <div className=" w-72 m-auto lg:mr-0  pt-[50px] pb-[50px]">
              ...
              <p className="p-2 font-poppins-light">
                ...
                illum odit architecto veniam. Ut velit, ea optio cumque ad
                omnis.
              </p>
              <p className="p-2 font-poppins-light">
                Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                Aliquid corrupti illum deserunt dolores maiores necessitatibus
                ipsum saepe id sequi vero.
              </p>
