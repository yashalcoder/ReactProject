      ...
      <div className="bg-secondory pt-20 pb-20">
        <div className="ml-6 mr-4 bg-textcolor  w-[1300] h-[700px] lg:h-[500px]">
          <div className="container lg:grid grid-cols-2 border-b-4 pb-4 border-gray">
            <div className="m-auto w-[430px] mt-11">
              <h1 className="text-primary font-poppins-bold p-1 text-xl">
                Recent Search
              </h1>
              <p className="font-poppins-medium text-textgray p-1">
                http://apple.com
              </p>
              <div className="container flex">
                <p className="font-poppins-bold p-1 text-sm">
                  Report Generated:
                </p>
                <p className="text-textgray ml-9">
                  Tuesday,June 13 2023 8:00pm
                </p>
              </div>
            </div>
            <div className="m-auto pl-36 mr-11">
              <div className="container flex mt-9">
                <button className="bg-primary rounded-md text-textcolor rounded-r-none font-poppins-medium border-r p-1">
                  Export Details
                </button>
                <button>
                  <img
                    className="bg-primary p-2 rounded-md h-11 rounded-l-none"
                    width={30}
                    src={download}
                    alt=""
                  />
              ...
              <div className="container flex mt-2">
                <button className="bg-primary w-28 rounded-md text-textcolor rounded-r-none font-poppins-medium border-r p-1">
                  Run Again
                </button>
                <button>
                  <img
          ...
          <div className="container lg:grid grid-cols-2 mt-[50px]">
            <div className="text-sm grid grid-cols-3  mt-6 w-[430px] m-auto font-poppins-medium">
              ...
              <p className="font-poppins-light m-auto mt-11 w-96">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Optio
                incidunt fuga reiciendis sequi numquam unde corporis minus porro
                facere maiores? Lorem ipsum dolor sit amet, consectetur
                adipisicing elit. Ea, sit?
              </p>
            </div>
            <div className=" w-96 sm:m-auto mt-6">
              <h1 className="font-poppins-bold text-primary text-lg">
                Overall Performance
              </h1>
        ...
        <div className="bg-textcolor h-36 ">
          <div className=" mt-11 pt-9 pb-11 h-11 ml-11 mr-11 ">
            <div className="lg:flex border-4 text-xl border-gray">
              <Link to="/Reportissues">
                <button className="border-r-2 hidden lg:block border-gray  hover:bg-primary hover:text-textcolor  font-poppins-light p-4 ">
                  issues to fix
                </button>
              </Link>
              <Link to="/ReportCommonSEOissues">
                <button className="border-r-2 hidden lg:block border-gray hover:bg-primary  hover:text-textcolor  font-poppins-light p-4 ">
                  Common SEO issues
                </button>
              </Link>
              ...
              <button className=" hidden lg:block hover:bg-primary hover:text-textcolor  font-poppins-light p-4">
                Advanced SEO
              </button>
              <a
                href="#0"
                className="block lg:hidden bg-primary text-textcolor w-full text-center py-3 px-4  text-white xl:rounded-l-none rounded-l-lg  rounded-r-lg bg-purple-600"
              >
                View All
              </a>
            </div>
        ...
        <div className="bg-textcolor ml-6 mr-4 mt-4">
          <div className="lg:grid grid-cols-2">
            <h1 className="font-poppins-bold text-lg pt-6 w-96 m-auto">
              Common SEO issues
            </h1>
          ...
          <div className="lg:grid grid-cols-2">
            <div className=" w-96 m-auto mt-6">
              ...
              <div className="block opacity-30 ml-6">
                100% of top 100 sites passed
              </div>
            </div>
            <div className=" m-auto lg:mr-0 lg:-ml-32 lg:w-[627px]">
              <p className="opacity-30 m-3">
                This webpage is using a tittle tag
              </p>
              <div className="p-4 m-3 bg-gray   border-l-4 font-poppins-medium border-icongreen">
                <p className="flex gap-2">
                  Text:<p className="opacity-40"> Name of the meta tittle</p>
                </p>
                <p className="flex gap-2">
                  Lenght:<p className="opacity-40">Length of characters</p>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:grid grid-cols-2">
            ...
            <div className=" m-auto lg:mr-0 lg:-ml-32 lg:w-[627px]">
              <p className="opacity-30 m-3">
                ...
                tempora facilis tenetur fuga in ab iste libero molestiae optio
                expedita!
              </p>
              <div className="p-4 m-3 bg-gray  border-l-4 font-poppins-medium border-icongreen">
                <p className="flex gap-2">
          ...
          <div className="lg:grid grid-cols-2">
            ...
            <div className="  m-auto lg:mr-0 lg:-ml-32 lg:w-[627px] ">
              <p className="opacity-30 m-3 font-poppins-medium">
                Desktop Version
              </p>
              <div className="p-4 m-3 border-8 font-poppins-medium border-gray">
                <a href="https://www.facebook.com/" className=" text-icongreen">
                  https://www.facebook.com/
                </a>
                <p className="text-darkblue flex gap-2">
                  Facebook - log in or sign up
                </p>
                <p className="opacity-40 lg:w-[580px]">
                  Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                  Reprehenderit eaque commodi laborum aliquid{" "}
                </p>
              </div>
          ...
          <div className="lg:grid grid-cols-2">
            ...
            <div className=" m-auto lg:mr-0 text-sm lg:-ml-32 w-[400px] lg:w-[627px] ">
              <p className="  m-3 opacity-30 font-poppins-medium">
                This website is using social media meta tags
              </p>
              <div className="m-3 font-poppins-medium ">
                <p className="bg-secondory ">
                  <p className="p-2 opacity-30">Open graph meta tags</p>
                </p>
                <p className="flex opacity-30 p-2 gap-7">
                  og:site_name<p>Facebook</p>
                </p>
                <p className="border-b-2 border-gray"></p>
                <p className="flex opacity-30 p-2 gap-[88px]">
                  og:url
                  <a href="htttps://www.facebook.com/">
                    htttps://www.facebook.com/
                  </a>
                </p>
                <p className="border-b-2 border-gray"></p>
                <div className="flex opacity-30 p-2 gap-[60px]">
                  <p>og:image</p>
                  <a
                    href="https://www.facebook.com
                    /images/fb_icon_325_325.png"
                    className=""
                  >
                    https://www.facebook.com /images/fb_icon_325_325.png
                  </a>
                </div>
                <p className="border-b-2 border-gray"></p>
                <p className="flex opacity-30 p-2 gap-16">
                  og:locale<p>en_US</p>
                </p>
                <p className="border-b-2 border-gray"></p>
              </div>
          ...
          <div className="lg:grid grid-cols-2">
            ...
            <div className="  m-auto lg:mr-0 lg:-ml-32 lg:w-[627px] ">
              <p className="opacity-30 m-3 font-poppins-medium">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Excepturi ut est asperiores laudantium voluptatem beatae amet.
                Impedit nostrum porro dicta? Lorem ipsum dolor, sit amet
                consectetur adipisicing elit. Eius debitis porro adipisci
                tempora sapiente error deserunt pariatur in illo alias?
              </p>
            </div>
          </div>
        </div>
